                    ...
                    <div className="col-12 col-md-7">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="tel" name="telnum" placeholder="Last Name" value={this.state.telnum} onChange = {this.handleInputChange}/>
                                </Col>
                            </FormGroup>
                            ...
                            <FormGroup row>
                                <Col md={{ size: 6, offset: 2 }}>
                                    <FormGroup check>
                                        <Label check >
                                            <Input type="checkbox" name="agree" placeholder="Email" value={this.state.agree} onChange = {this.handleInputChange}/>
                                ...
                                <Col md={{ size: 3, offset: 1 }}>
                                    <Input type="select" name="contactType" placeholder="contactType" value={this.state.contactType} onChange = {this.handleInputChange}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Input>
                                </Col>
